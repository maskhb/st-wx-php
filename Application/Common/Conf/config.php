...
//        'DB_PWD'    => 'root',  // 密码
//        'DB_PORT'   => '3306', // 端口
//        'DB_PREFIX' => 'fcwx_', // 数据库表前缀
//		'DB_PARAMS' => array (
//				\PDO::ATTR_CASE => \PDO::CASE_NATURAL
//		),

        /*坑爹，onethink这个配置不生效，2016.12.26已修复*/
        'LOAD_EXT_CONFIG' => 'db',
		
		// 系统数据加密设置
		'DATA_AUTH_KEY' => ']Nv<;w~6-_CXVnuIs0i2>9S&j8%}=Qgc"HW5bE(a', // 默认数据加密KEY
...
//		'DATA_CACHE_TYPE' => 'File', // 数据缓存类型
        /*2017.01.17更改缓存方式为数据库，不然多机器负载均衡时accesstoken会出问题*/
        'DATA_CACHE_TABLE' =>'stwx_cache',
        'DATA_CACHE_TYPE' =>'Db',
